...
public class NotHesaplamaFormu : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        // Kontrolleri ve etiketleri oluşturuyoruz.
        ...
        // Hesapla ve Kaydet butonlarını oluşturuyoruz.
        ...
        // Logo PictureBox'ını oluşturuyoruz.
        logoPictureBox = new PictureBox
        {
            Image = Image.FromFile(@"E:\dev\C#\veri tabanlı destekli görsel programlama\notHesaplama\imge.jpg"), // Logonuzun dosya yolu
            ...
            Size = new Size(50, 50) // PictureBox'ın boyutları, logo boyutunuza göre ayarlayın
        };


        // Oluşturulan kontrol ve etiketleri forma ekliyoruz.
    ...
    {
        // Notları TextBox'lardan alıyoruz ve hesaplıyoruz.
            ...
            double.TryParse(odevTextBox.Text, out double odev))
        {
            ...
            kaydetButton.Enabled = true; // Kaydet butonunu etkinleştiriyoruz.
        }
        else
        {
    ...
    {
        // Ortalamayı veritabanına kaydediyoruz.
    ...
    {
        // Veritabanı bağlantı dizesini oluşturuyoruz ve bağlantıyı açıyoruz.
        string connectionString = "server=localhost;port=3306;database=hesapmakinesi;user=root;password=;";
    ...
    {
        // Form kapatıldığında veritabanı bağlantısını kapatıyoruz.
